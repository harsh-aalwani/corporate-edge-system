          ...
          <div className="row">
            ...
            <div className="container">
              ...
              <div className="row">
                ...
                {/* Department (Disabled Textbox) */}
                <div className="col-md-6 mb-3">
                  <label className="form-label">Department:</label>
                  <input type="text" name="department" className="form-control" value={formData.department} disabled />
                </div>

                {/* Job Preferences Dropdown */}
                <div className="col-md-6 mb-3">
                  <label className="form-label">Job Preferences:</label>
                  <select name="jobPreferences" className="form-control" value={formData.jobPreferences} onChange={handleChange} required>
                ...
                <div className="col-md-6 mb-3">
                  <label className="form-label">Availability & Expected Salary:</label>
            ...
            <button
              ...
              onClick={() => {
                setFormData({
                 ...
                 // Job Position Details :
                  position: "",
                  department: "Software Development", // Default value
                  jobPreferences: "",
                  skills: "",
                  specialization: "",
                  salary: "",
