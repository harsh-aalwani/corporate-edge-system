...
const ReceiveAnnouncements = () => {
  ...
  const generatePDF = () => {
    ...
    if (selectedAnnouncement.announcementPublic) {
      // 📝 PDF for Public Announcement
      content.innerHTML = `
        <div style="padding:20px; font-family: 'Times New Roman'; font-size:14px;">
          <h2 style="font-weight:bold; color:#000;">📢 Public Announcement Details</h2>
          ...
          <p style="color:#000;"><strong>💼 Job Type:</strong> ${selectedAnnouncement.jobType || "Not specified"}</p>
          <p style="color:#000;"><strong>📈 Experience Required:</strong> ${selectedAnnouncement.experienceRequired || "Not specified"}</p>
          <p style="color:#000;"><strong>🎓 Education Qualification:</strong> ${selectedAnnouncement.educationQualification || "Not specified"}</p>
          <p style="color:#000;"><strong>📝 Application Deadline:</strong> ${new Date(selectedAnnouncement.applicationDeadline).toLocaleDateString()}</p>
          <p style="color:#000;"><strong>👥 Total Vacancies:</strong> ${selectedAnnouncement.totalVacancy || "Not specified"}</p>
          <p style="color:#000;"><strong>💰 Salary Range:</strong> ${
            selectedAnnouncement.salaryRange ? `${selectedAnnouncement.salaryRange.min} - ${selectedAnnouncement.salaryRange.max}` : "Not specified"
          }</p>
          <hr style="border:1px solid #000; width:100%">
