                ...
                <form className="custom-form" onSubmit={handleSubmit} method="POST" encType="multipart/form-data">
                    ...
                    {currentStep === 3 && (
                        <div className="row">
                            ...
                            <div className="col-md-6 mb-3">
                                <label className="form-label">Account Activation: <span style={{ color: "red" }}>*</span></label>
                                <input 
                                    type="datetime-local" 
                    ...
                    <div className="d-flex justify-content-between w-100 mt-1">
                        ...
                        <div className="d-flex justify-content-between w-100 mt-4">
                            ...
                            {currentStep > 1 && (
                                ...
                                onClick={() => setCurrentStep((prev) => Math.max(prev - 1, 1))} // Prevent going below 1
                                >
                                Back
                                </button>
                            )}
                            ...
                            onClick={() => {
                                ...
                                // Show Snackbar Message
                                enqueueSnackbar("✅ Form cleared & reset to Step 1!", { 
                                variant: "warning", 
                                autoHideDuration: 3000 
                                });
                            }}
                            ...
                            {currentStep < 4 && (
                                ...
                                onClick={() => setCurrentStep((prev) => Math.min(prev + 1, 4))} // Prevent exceeding 4
                                >
                                Next
                                </button>
                            )}
