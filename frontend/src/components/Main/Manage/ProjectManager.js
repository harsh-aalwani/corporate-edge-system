  ...
  const rows = [
    {
      ...
      projects: "Project A, Project B",  // Added Projects field
      isOnline: true,
    },
    {
      id: "4616",
      ...
      projects: "Project C",  // Added Projects field
      isOnline: false,
    },
    {
      id: "9841",
      ...
      email: "Senior High",
      department: "Sales",  
      projects: "Project D, Project E",  // Added Projects field
      isOnline: true,
    },
    {
      id: "9548",
      ...
      email: "College",
      department: "HR",  
      projects: "Project F",  // Added Projects field
      isOnline: false,
    },
  ];
          ...
          <table className="table custom-table">
            <thead>
              <tr>
                ...
                <th scope="col">Projects</th> {/* Projects column added */}
                <th scope="col">
            ...
            <tbody>
              {rows.map((row) => (
                ...
                >
                  ...
                  <td>{row.projects}</td> {/* Display Projects field */}
                  <th scope="row">
                    <label className="control control--checkbox">
                      <input
                        type="checkbox"
