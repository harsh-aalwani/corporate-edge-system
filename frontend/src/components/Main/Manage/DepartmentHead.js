  ...
  const rows = [
    {
      ...
      email: "NY University",
      department: "Engineering",  // Added Department field
      isOnline: true,
    },
    {
      id: "4616",
      ...
      department: "Marketing",  // Added Department field
      isOnline: false,
    },
    {
      id: "9841",
      ...
      email: "Senior High",
      department: "Sales",  // Added Department field
      isOnline: true,
    },
    {
      id: "9548",
      ...
      email: "College",
      department: "HR",  // Added Department field
      isOnline: false,
    },
  ];
  ...
  return (
    <div className="page-inner page-box page-start" style={{ marginTop: "60px" }}>
      <div className="d-flex align-items-center align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
          <h4 className="fw-bold mb-3">Manage Department Heads</h4> {/* Changed title */}
          <h6 className="op-7 mb-2">Add, Change and Delete Department Heads</h6> {/* Updated description */}
        </div>
            ...
            <tbody>
              {rows.map((row) => (
                ...
                >
                  ...
                  <td>{row.email}</td>
                  <td>{row.mobile}</td>
                  <td>{row.department}</td> {/* Department field */}
                  <th scope="row">
                    <label className="control control--checkbox">
                      <input
                        type="checkbox"
